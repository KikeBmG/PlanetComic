...
<head>
	...
	<!--	JavaScripts propios y Plugin estrellas		-->
...
<body>
	...
	<nav class="navbar navbar-toggleable-md bg-dark navbar-dark sticky-top">
		...
		<div class="navbar-brand">
			<form class="form-inline my-2 my-lg-0" action="buscador.php" get="post">
		...
		<div class="collapse navbar-collapse" id="navbarTogglerDemo02">
			<ul class="navbar-nav mr-auto mt-2 mt-md-0">
				<li class="nav-item">
					<a class="nav-link" href="#" id="Leido" onclick="marcaActivo(this)">Leídos<span id="contLeido"></span></a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="#" id="Leyendo" onclick="marcaActivo(this)">Leyendo<span id="contLeyendo"></span></a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="#" id="Pendiente" onclick="marcaActivo(this)">Pendiente<span id="contPendiente"></span></a>
				</li>
			</ul>
			<ul class="navbar-nav mr-auto mt-2 mt-md-0">
				<li class="nav-item">
	...
	<div id="modal"></div>
	<span class="invisible" id="<?php echo $estado; ?>"></span>
</body>
</html>