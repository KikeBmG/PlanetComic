function calculate_age(dob) {
	...
	var fechas = dob.split("-");
	
	var fecha = new Date(fechas[2],fechas[1],fechas[0]);
	
    var diff_ms = Date.now() - fecha.getTime();
...
$(document).ready(function() {
	...
	var idIlustrador = $('span.invisible').attr('id');
	...
	$.getJSON("datosIlustrador.php?idIlustrador=" + idIlustrador,function(data) {
		...
		var age = calculate_age(data[0].fechaNacIlustrador)
